...
public class GenericPersistentRepository extends AbstractPersistentRepository
	...
	public GenericPersistentRepository(String entityType, String generatedPK, String userIdField, String timestampField,
		...
		this(entityType, generatedPK, userIdField, timestampField, versionField, persistenceContext, null, null);
	}

	public GenericPersistentRepository(String entityType, String fieldsPK, String userIdField, String timestampField,
			String versionField, PersistenceManager persistenceContext, String autogenerated,
			String autogeneratedFormula) {
		super(persistenceContext);
		this.entityType = entityType;
		this.fieldsPK = fieldsPK == null ? new String[0] : fieldsPK.split("\\s*,\\s*");
		this.userIdField = userIdField;
		this.timestampField = timestampField;
		this.versionField = versionField;
		this.autogenerated = autogenerated;
		this.autogeneratedFormula = autogeneratedFormula;
	}
	...
	public void insert(Map<String, Object> item, Principal principal) {
		...
		for (String field : getFieldNames(item)) {
			fields += prefix + field;
			if (field.equalsIgnoreCase(autogenerated)) {
				values += prefix + autogeneratedFormula;
				for (String fieldName : RegexUtil.listOccurrences(regexHTML("(\\w+)\\s*=\\s*\\?"),
						autogeneratedFormula))
		...
		if (autogenerated != null) {
			sql += " RETURNING " + autogenerated;
			int id = executeReturningSQL(sql, parms.toArray());
			item.put(autogenerated, id);
		} else
	...
	protected boolean isPK(String fieldName) {
		for (String fieldPK : fieldsPK)
			if (fieldPK.equalsIgnoreCase(fieldName))
				return true;
		return false;
	}
	...
	protected List<String> getFieldNames(Map<String, Object> map) {
		...
		for (String fieldPK : fieldsPK)
			if (!fieldNames.contains(fieldPK))
				fieldNames.add(fieldPK);
		if (autogenerated != null && !fieldNames.contains(autogenerated))
			fieldNames.add(autogenerated);
